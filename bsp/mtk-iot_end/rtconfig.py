...
if PLATFORM == 'gcc':
    ...
    CFLAGS = DEVICE + ' --apcs=interwork -DMTK_DEBUG_LEVEL_NONE  -DPRODUCT_VERSION=7697 -DCFG_SUPPORT_SMNT_PROTO=2 -DMTK_HAL_NO_LOG_ENABLE'
    AFLAGS = DEVICE
    LFLAGS = DEVICE + ' --info sizes --info totals --info unused --info veneers --list rtthread-mt76xx.map --scatter flash.sct'
